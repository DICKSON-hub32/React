  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={onClose}
          className="fixed top-4 right-4 text-gray-600 hover:text-gray-800 z-60"
        ...
        {/* Modal content with sticky top-right close button */}
        <div className="relative">
          <div className="sticky top-0 z-50">
            <button
              onClick={onClose}
              className="absolute top-0 right-0 bg-blue-600 text-white rounded-full p-2 hover:bg-blue-700"
              aria-label="Close modal"
            >
              <svg
                className="w-5 h-5"
          ...
          <div className="text-gray-800 leading-relaxed pt-8">
            <h1 className="text-2xl font-bold mb-4">Privacy Policy</h1>
            <p className="mb-4">Last updated: April 16, 2025</p>
            <p className="mb-4">
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li className="mb-2">
                <p>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to Movie Finder
                  - Teckish.
                </p>
              </li>
              <li className="mb-2">
              ...
              <li className="mb-2">
                <p>
                  <strong>Website</strong> refers to Movie Finder - Teckish,
                  accessible from{" "}
                  <a
                    href="https://moviefinder-teckish.com/"
                    rel="external nofollow noopener"
                    target="_blank"
                    className="text-blue-600 hover:underline"
                  >
                    https://moviefinder-teckish.com/
                  </a>
                </p>
              </li>
              <li className="mb-2">
            ...
            <h4 className="text-base font-medium mt-3 mb-2">Personal Data</h4>
            <p className="mb-4">
            ...
            <h4 className="text-base font-medium mt-3 mb-2">Usage Data</h4>
            <p className="mb-4">
            ...
            <h4 className="text-base font-medium mt-3 mb-2">Law enforcement</h4>
            <p className="mb-4">
            ...
            <ul className="list-disc pl-6 mb-4">
              <li className="mb-2">By email: info@moviefinder-teckish.com</li>
            </ul>
          </div>
        </div>
      </div>
